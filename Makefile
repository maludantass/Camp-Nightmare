...
SOURCES = $(SRC_DIR)/main.c $(SRC_DIR)/menu.c $(SRC_DIR)/map.c $(SRC_DIR)/keyboard.c $(SRC_DIR)/screen.c $(SRC_DIR)/timer.c $(SRC_DIR)/medio.c $(SRC_DIR)/facil.c $(SRC_DIR)/dificil.c $(SRC_DIR)/leaderboard.c
